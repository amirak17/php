define(['jquery'], function($) {
  function CropCircle(elem, options) {
    ...
    var frameRect = {
      top: 10,     // (options.top || options.top === 0) ? options.top : 100,
      left: 10,    //(options.left || options.left === 0) ? options.left : 100,
      bottom: 100, //(options.bottom || options.bottom === 0) ? options.bottom : 100,
      right: 100   //(options.right || options.right === 0) ? options.right : 100
    };
